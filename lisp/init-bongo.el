(use-package bongo
  :ensure
  :config
  (setq bongo-default-directory "/Users/chenjing/workspace/github/gnuser/QQFlacMusicDownloader")
...
Also see `prot/bongo-playlist-insert-playlist-file'."
    ...
    (let* ((dotless directory-files-no-dot-files-regexp)
           (pldir "/Users/chenjing/workspace/github/gnuser/QQFlacMusicDownloader/music/playlists")
           (playlists (mapcar
                       'abbreviate-file-name
